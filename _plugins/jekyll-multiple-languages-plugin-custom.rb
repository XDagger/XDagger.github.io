...
To avoid copying non static files under every language, this version contains lines 
from https://github.com/blurb/jekyll-multiple-languages-plugin/blob/016326aaa837fd06453d6c60b4f8ba1ff45cbbcf/lib/jekyll-multiple-languages-plugin.rb
=end



module Jekyll
  module MultipleLanguagesPluginCustom
    VERSION = "1.5.1"
  end
end
